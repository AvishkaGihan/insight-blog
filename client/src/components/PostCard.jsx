...
export default function PostCard({ post }) {
  ...
  return (
    <div className="group relative w-full h-[400px] flex flex-col overflow-hidden rounded-2xl border border-gray-200/50 dark:border-white/10 hover:border-amber-500/50 hover:shadow-[0_12px_40px_rgba(245,158,11,0.08)] bg-white dark:bg-[#0d0e12]/80 sm:w-[320px] transition-all hover:scale-[1.02] duration-300">
