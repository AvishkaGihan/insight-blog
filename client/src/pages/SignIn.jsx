        ...
        <div className="flex-1 flex flex-col justify-center items-start gap-6 pr-0 md:pr-8">
          ...
          <div className="flex flex-col gap-3 text-left">
            ...
            <p className="text-sm text-gray-500 dark:text-text-muted leading-relaxed">
              Sign in to explore tested source code, write technical notes, bookmark framework guides, and connect with other developers.
            </p>
          </div>
        ...
        <div className="flex-1 flex flex-col justify-center">
          <div className="w-full border border-amber-500/20 p-6 md:p-8 rounded-2xl">
            ...
            <div className="flex gap-1.5 text-xs font-semibold justify-center mt-5">
              <span className="text-gray-500 dark:text-text-muted">Don&apos;t have an account?</span>
              <Link to="/sign-up" className="text-amber-600 hover:text-amber-500 dark:text-amber-500 dark:hover:text-amber-400 transition-colors duration-150">
                Sign Up
              </Link>
            </div>
